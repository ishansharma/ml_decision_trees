...
from tests import test_heuristics
...
def suite():
    ...
    test_suite.addTest(test_heuristics.TestHeuristics('test_calculate_entropy'))

    # tests for variance impurity calculation
    test_suite.addTest(test_heuristics.TestHeuristics('test_variance_impurity'))

    # tests for information gain
    test_suite.addTest(test_heuristics.TestInformationGainHeuristic('test_ig_heuristic'))
